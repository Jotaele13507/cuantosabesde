...
<body>
  ...
  <div class="row footer">
    ...
    <div class="col-md-3 box">
      <a href="#" data-toggle="modal" data-target="#loginprof">Acceso Profesores</a>
    </div>
    <div class="col-md-3 box">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><span style="color:orange;font-family:'typo' ">Acceso exclusivo para Profesores</span></h4>
        </div>
  ...
  <div class="modal fade" id="login">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h4 class="modal-title"><span style="color:orange;font-family:'typo' ">Acceso exclusivo para Administradores</span></h4>
        </div>
        <div class="modal-body title1">
          <div class="row">
            <div class="col-md-3"></div>
